...
R code could be find via [run_analysis.R](run_analysis.R) file.


## Data CodeBook

The [codebook](CodeBook.Rmd) available in this repo as well, which is to explain how to finish the Proejct Requirement above-mentioned.
